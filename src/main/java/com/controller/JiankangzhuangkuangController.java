...
public class JiankangzhuangkuangController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiankangzhuangkuangEntity jiankangzhuangkuang,
		...
		if(tableName.equals("yonghu")) {
			jiankangzhuangkuang.setZhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("hulirenyuan")) {
			jiankangzhuangkuang.setHulizhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiankangzhuangkuangEntity jiankangzhuangkuang, 
		HttpServletRequest request){
        EntityWrapper<JiankangzhuangkuangEntity> ew = new EntityWrapper<JiankangzhuangkuangEntity>();
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		if(tableName.equals("hulirenyuan")) {
            ew.eq("hulizhanghao", (String)request.getSession().getAttribute("username"));
		}
        List<Map<String, Object>> result = jiankangzhuangkuangService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiankangzhuangkuangService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiankangzhuangkuangService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
